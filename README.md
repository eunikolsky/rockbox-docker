...
After several hours of tinkering, I've built a functional, modern Dockerfile that allows me to patch and then build a working RockBox build for my ~~iPod Mini~~ Sansa Clip+.
...
*This is to help you at compiling full builds of Rockbox for your ~~iPods~~ Sansa Clip+. If you are interested only by the database tool, you can skip this whole section.*
